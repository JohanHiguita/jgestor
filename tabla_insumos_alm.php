...
<head>
  ...
  <title>jGestor - Equipos en almacén</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Insumos en almacén</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de insumos en almacén</div>
          <?php //mostrar tabla de Clientes
            ...
            $header=getHeadersInsumosAlm();
            $matrizInsumos=getTabla("insumos_almacen");
            insertTableInsumos($header,$matrizInsumos,"insumos");
          ?>
    ...
    <div class="modal fade" id="editarModal" tabindex="-1" role="dialog" aria-labelledby="EditarModalLabel" aria-hidden="true">
      <div  class="modal-dialog" role="document">
        <div class="modal-content" id="modalContentEditar">
          <div class="modal-header">
            <h5 class="modal-title" id="EditarModalLabel">Editar equipo almacén</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="contEditarForm">
              <form id="formEditEquipoAlm"class="editarEquipoAlmForm" action="controlador_editarEquipoAlm.php" method="get">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="inpSerial">Serial-almacén:</label>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="inpSerial" id="inpSerial" readonly></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpMarca" id="inpMarca"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpModelo" id="inpModelo"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="date" name="inpFechaCompra" id="inpFechaCompra"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="inpPrecioCompra" id="inpPrecioCompra"></input><br>
                  </div>
                </div>
              </form>
            </div>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-success" type="submit" name="enviar" form="formEditEquipoAlm">Actualizar</button>
            <!-- <a class="btn btn-primary" href="login.html">Logout</a> -->
          </div>
        </div>
      </div>
    </div>
    <!-- detalles equipos almacen Modal-->
    <div class="modal fade" id="detallesModal" tabindex="-1" role="dialog" aria-labelledby="equiposAlmModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="equiposAlmModalLabel">Detalles del Equipo</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <h5 id='nombre_ea'></h5><br/>
            <h5><b>Serial Almacén: </b></h5>
            <span  id='serial_ea'></span><br/>
            <h5><b>Marca: </b></h5>
            <span  id='marca_ea'></span><br/>
            <h5 ><b>Modelo: </b></h5>
            <span id='modelo_ea'></span><br/>
            <h5 ><b>Fecha de compra: </b></h5>
            <span id='fechai_ea'></span><br/>
            <h5 ><b>Precio de compra: </b></h5>
            <span id='precioc_ea'></span><br/><br/>
            <div class="detallesEquipoAlm">
              <button id="btn_darSalida" class="btn btn-info btn-xs" role="button">Dar salida</button>
            </div>
    ...
    <div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarModalLabel">Eliminar registro de equipo en almacén</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body text-center">
            ¿Está seguro de eliminar el equipo de serial
          ...
          <div class="modal-body">
            <div class="contAgregarForm">
                <form id="formAgregarCliente" class="agregarClienteForm" action="controlador_AgregarCliente.php" method="get">
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpRes">Responsable:</label>
                    </div>
                    <div class="col-sm-6">
    ...
    <div class="modal fade" id="agregarE mpleadoModal" tabindex="-1" role="dialog" aria-labelledby="AgregarModalLabel" aria-hidden="true">
      <div  class="modal-dialog " role="document">
        <div class="modal-content" id="modalContentAgregar">
          <div class="modal-header">
    ...
    <!--trasladar a Vendido Insumo Modal  -->
    <div class="modal fade" id="trasladoInsumosVendModal" tabindex="-1" role="dialog" aria-labelledby="AgregarModalLabel" aria-hidden="true">
      <div  class="modal-dialog " role="document">
        <div class="modal-content" id="modalContentAgregar">
          <div class="modal-header">
            <h5 class="modal-title" id="AgregarModalLabel">Trasladar insumo a vendido</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="contAgregarForm">
                <form id="formAgregarInsumoVendido" class="agregarInsumoVendidoForm" action="controlador_AgregarInsumoVendido.php" method="get">
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpCod">codigo:</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="inpCod" id="inpCod" readonly></input><br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="inpNombre" id="inpNombre" readonly></input><br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <input type="number" name="inpPC" id="inpPC" readonly></input><br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                      <input type="number" name="inpCantidad" id="inpCantidad" readonly></input><br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpFvencimiento">Fecha de vencimiento de esterilización:</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="text" name="inpFvencimiento" id="inpFvencimiento" readonly></input><br>

                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpPV">Precio de venta ($):</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="number" name="inpPV" id="inpPV"></input><br>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpFventa">Fecha de venta:</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="date" name="inpFventa" id="inpFventa"></input><br>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-6">
                      <select type="text" name="inpCliente" id="inpCliente"></select><br>
                    </div>
                  </div>
              </form>
            </div>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-default" type="button" data-dismiss="modal">Cancelar</button>
            <button class="btn btn-success" type="submit" name="enviar" id="btn_trasladarInsumo" form="formAgregarInsumoVendido">Trasladar</button>

          </div>
        </div>
      </div>
    </div>
    <!--trasladar a Consignacion Insumo Modal  -->
    <div class="modal fade" id="trasladoInsumosConsModal" tabindex="-1" role="dialog" aria-labelledby="AgregarModalLabel" aria-hidden="true">
      <div  class="modal-dialog " role="document">
        <div class="modal-content" id="modalContentAgregar">
          <div class="modal-header">
            <h5 class="modal-title" id="AgregarModalLabel">Trasladar insumo a consignación</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="contAgregarForm">
                <form id="formAgregarInsumoConsignacion" class="agregarInsumoConsignacionForm" action="controlador_AgregarInsumoConsignacion.php" method="get">
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpCod">codigo:</label>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      <label for="inpFentrega">Fecha de entrega:</label>
                    </div>
                    <div class="col-sm-6">
                      <input type="date" name="inpFentrega" id="inpFentrega"></input><br>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-default" type="button" data-dismiss="modal">Cancelar</button>
            <button class="btn btn-success" type="submit" name="enviar" id="btn_trasladarInsumo" form="formAgregarInsumoConsignacion">Trasladar</button>
