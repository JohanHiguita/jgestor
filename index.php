...
<head>
  ...
  <title>jGestor - Gestión de activos biomédicos</title>
  <!-- Bootstrap core CSS-->
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive"> <!-- contenedor derecho del nav -->
      ...
      <ul class="navbar-nav ml-auto"> <!-- nav superior -->
        <li class="nav-item dropdown"><!--  Alertas carga laboral (amarillo)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <span class="d-lg-none">Carga laboral
              <span class="badge badge-pill badge-warning badgeAlertaCL">6 Nuevos</span> <!--  responsive -->
            </span>
        ...
        <li class="nav-item"> <!-- LogOut -->
          <a class="nav-link" data-toggle="modal" data-target="#equiposExtModal" id="salir">
  ...
  <div class="content-wrapper"> <!-- Contenido central -->
    <div class="container-fluid">
      ...
      <!-- Icon Cards-->
      <div class="row">
        <div class="col-xl-4 col-sm-4 mb-12"> <!-- insumos -->
          <div class="card text-white o-hidden h-100" id="card-insumos">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-stethoscope"></i>
              </div>
              <div class="mr-5">Alertas Compras de insumos</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="view_AlertasInsumos">
              <span class="float-left">Ver Tabla</span>
        ...
        <div class="col-xl-4 col-sm-4 mb-12"> <!-- carga Laboral -->
          <div class="card text-white o-hidden h-100" id="card-cl">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-sort-amount-asc"></i>
              </div>
              <div class="mr-5">Alertas Carga laboral</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="view_AlertasCargaLaboral.php">
              <span class="float-left">Ver Tabla</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-4 col-sm-4 mb-12"> <!-- correctivos -->
          <div class="card text-white o-hidden h-100" id="card-corrs">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-user-times"></i>
              </div>
              <div class="mr-5">Alertas Frecuencia de correctivos</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="view_AlertasCorrectivos.php">
              <span class="float-left">Ver Tabla</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
      ...
      <div class="row">
        <div class="col-xl-4 col-sm-4 mb-12"> <!-- insumos -->
          <div class="card text-white o-hidden h-100" id="card-procs">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-wrench"></i>
              </div>
              <div class="mr-5">Alertas próximos procedimientos</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="view_AlertasProcedimientos">
              <span class="float-left">Ver Tabla</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
        ...
        <div class="col-xl-4 col-sm-4 mb-12"> <!-- carga Laboral -->
          <div class="card text-white o-hidden h-100" id="card-fv">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-recycle"></i>
              </div>
              <div class="mr-5">Alertas esterilización insumos</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="view_AlertasEsterilizacion.php">
              <span class="float-left">Ver Tabla</span>
              <span class="float-right">
                <i class="fa fa-angle-right"></i>
              </span>
