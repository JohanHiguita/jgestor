...
<html>
  ...
  <body class="bg-dark">
    <?php
      ...
      //echo implode("-",$infoProcedimiento);
      if (isset($_POST["usuario_adm"]) && $_POST["psw_adm"]){
        ...
        if ($existe) {
          ...
          if ($coinciden) {
            updateProcedimiento($infoProcedimiento);
            $linkExito="view_PermitidoEditarProcedimiento.php?codigo=" .$codigo. "&".
            "tipo=" .$tipo;
        ...
        if ($accesoNegado==1) {
          $linkNoAcceso="view_NegadoEditarProcedimiento.php?codigo=" .$codigo. "&".
          "tipo=" .$tipo;
