  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de empleados</div>
          <?php //mostrar tabla de empleados
            require_once("view_funciones.php"); // Funciones de la vista
            require_once("controlador_funciones.php"); //Funciones del controlador
            $header=getHeadersEmpleados();
            $matrizEmpleados=getTabla("empleados");
            insertTable($header,$matrizEmpleados,"empleados");
          ?>
    ...
    <div class="modal fade" id="detallesModal" tabindex="-1" role="dialog" aria-labelledby="equiposAlmModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="equiposAlmModalLabel">Detalles empleados</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <h5 id='nombre_emp'></h5><br/>
            <h5><b>Cédula: </b></h5>
            <span  id='cc_emp'></span><br/>
            <h5 ><b>Cargo: </b></h5>
            <span id='cargo_emp'></span><br/>
            <h5 ><b>Teléfono: </b></h5>
            <span id='tel_emp'></span><br/>
            <h5 ><b>Correo electrónico: </b></h5>
            <span id='correo_emp'></span><br/>
          </div>
          <div class="modal-footer">
        ...
        <div class="modal-content" id="modalContentEditar">
          ...
          <div class="modal-body">
            <div class="contEditarForm">
              <form id="formEditEmpleado" class="editarEmpleadoForm" action="controlador_editarEmpleado.php" method="get">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="inpCedula">Cédula:</label>
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="inpCedula" id="inpCedula" readonly></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpCargo" id="inpCargo"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpTel" id="inpTel"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-success" type="submit" name="enviar" form="formEditEmpleado">Actualizar</button>
            <!-- <a class="btn btn-primary" href="login.html">Logout</a> -->
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarModalLabel">Eliminar registro de empleado</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body text-center">
            ¿Está seguro de eliminar el registro del empleado de cédula
