...
<head>
  ...
  <title>jGestor - Carga laboral</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Gráfico tendencia de compras de insumo</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-bar-chart"></i> Compras de insumos en el ultimo año </div>
          <div class="chartDescription" >
            <form class="formComprasInsumos" method="get">
              <!-- Selects Insumo, cliente y botón -->
              <br/>
              <div>
                <label for="inpCliente">Cliente:</label>
                <select type="text" name="inpCliente" id="inpCliente"></select>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <label for="inpInsumo">Insumo:</label>
                <select type="text" name="inpInsumo" id="inpInsumo"></select>
                <span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
                <!-- <button class="btn btn-info btn-sm" id="btn-grafsCompras" >Ver Gráfico</button> -->
                <a id="btn-grafsCompras" data-toggle="modal" href="#graficoComprasModal" title="Ver compras"><i class="fa fa-fw fa-line-chart"></i></a>
              </div>
            </form>
          </div>
          <!-- <div class="card-body" id="contGraficoCompras">
            <canvas id="compras_insumos" width="100" height="50"></canvas>
          </div> -->
      </div>
    ...
    <div class="modal fade" id="detallesModal" tabindex="-1" role="dialog" aria-labelledby="equiposAlmModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="equiposAlmModalLabel">Detalles cliente</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <h5 id='nombre_cli'></h5><br/>
            <h5><b>Código cliente: </b></h5>
            <span  id='cod_cli'></span><br/>
            <h5><b>Ciudad: </b></h5>
            <span  id='ciudad_cli'></span><br/>
            <h5 ><b>Responsable: </b></h5>
            <span id='responsable_cli'></span><br/>
            <h5 ><b>email: </b></h5>
            <span id='correo_cli'></span><br/>
            <h5 ><b>Teléfono: </b></h5>
            <span id='tel_cli'></span><br/>
          </div>
          <div class="modal-footer">
        ...
        <div class="modal-content" id="modalContentEditar">
          ...
          <div class="modal-body">
            <div class="contEditarForm">
              <form id="formEditCliente" class="editarClienteForm" action="controlador_editarCliente.php" method="get">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="inpCodigo">Código cliente:</label>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpCiudad" id="inpCiudad"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpResponsable" id="inpResponsable"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpTel1" id="inpTel1"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-success" type="submit" name="enviar" form="formEditCliente">Actualizar</button>
            <!-- <a class="btn btn-primary" href="login.html">Logout</a> -->
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarModalLabel">Eliminar registro de cliente</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body text-center">
            ¿Está seguro de eliminar el registro del cliente
    ...
    <!--Graficos compras Modal  -->
    <div class="modal fade" id="graficoComprasModal" tabindex="-1" role="dialog" aria-labelledby="graficoComprasModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="graficoComprasModalLabel">Insumos cliente</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body" id="contGraficoCompras">
            <canvas id="compras_insumos" width="100" height="50"></canvas>
          </div>
          <div class="modal-footer">
            <button class="btn btn-primary" type="button" data-dismiss="modal">OK</button>
