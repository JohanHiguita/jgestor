  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Gráficos carga laboral</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-bar-chart"></i> Procedimientos por ingeniero</div>
          <div class="chartDescription" ><h5>Cantidad de cada tipo de procedimiento agendado en los próximos <b>10</b> dias para cada ingeniero</h5></div>
          <div class="card-body">
            <canvas id="CL_Todos" width="100" height="50"></canvas>
          </div>
      </div>
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-bar-chart"></i> Total Procedimientos por ingeniero </div>
          <div class="chartDescription" ><h5>Cantidad total de procedimientos agendados en los próximos <b>10</b> dias para cada ingeniero</h5></div>
          <div class="card-body">
            <canvas id="CL_Total" width="100" height="50"></canvas>
          </div>
      </div>
