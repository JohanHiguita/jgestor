      ...
      <div class="card mb-3">
        <div class="card-header">
          ...
          <?php //mostrar tabla de Clientes
            $serial=$_GET["serial"];
            echo '<i class="fa fa-table"></i> Tabla de Procedimientos - <b>Serial: '.$serial.'</b></div>';
            require_once("view_funciones.php"); // Funciones de la vista
            require_once("controlador_funciones.php"); //Funciones del controlador


            $header=getHeadersProcedimientos();//revisar
            $matrizProcEquipo=getTablaProcEquipo($serial);
            insertTable($header,$matrizProcEquipo,"procedimientos");
          ?>
