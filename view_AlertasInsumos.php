...
<head>
  ...
  <title>jGestor - Gestión de activos</title>
  <!-- Bootstrap core CSS-->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav"> <!-- barra navegación -->
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive"> <!-- contenedor derecho del nav -->
      ...
      <ul class="navbar-nav ml-auto"> <!-- nav superior -->
        ...
        <li class="nav-item dropdown"><!--  Alertas ventas insumos(morado)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-bell"></i>
            <span class="d-lg-none ">Venta insumos
              <span class="badge badge-pill badge-warning badgeAlertaInsumos">6 New</span> <!--  responsive -->
            </span>
            <span class="indicator text-warning d-none d-lg-block">
              <i class="fa fa-fw fa-circle alertaInsumos"></i>
        ...
        <li class="nav-item dropdown"><!--  Alertas carga laboral (amarillo)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-bell"></i>
            <span class="d-lg-none">Carga laboral
              <span class="badge badge-pill badge-warning badgeAlertaCL">6 New</span> <!--  responsive -->
            </span>
            <span class="indicator text-warning d-none d-lg-block">
              <i class="fa fa-fw fa-circle alertaCL"></i>
        ...
        <li class="nav-item dropdown"><!--  Alertas frecuentes correctivos (rojo)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-bell"></i>
            <span class="d-lg-none">Correctivos
              <span class="badge badge-pill badge-warning badgeAlertaCorrs">6 New</span> <!--  responsive -->
            </span>
            <span class="indicator text-warning d-none d-lg-block">
              <i class="fa fa-fw fa-circle alertaCorrs"></i>
        ...
        <li class="nav-item dropdown"><!--  Alertas proximos procedimientos (verde)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-bell"></i>
            <span class="d-lg-none">Procedimientos
              <span class="badge badge-pill badge-warning badgeAlertaProcs">6 New</span> <!--  responsive -->
            </span>
            <span class="indicator text-warning d-none d-lg-block">
              <i class="fa fa-fw fa-circle alertaProcs"></i>
        ...
        <li class="nav-item dropdown"><!--  Alertas fecha esterilización (azul)-->
          <a class="nav-link dropdown-toggle mr-lg-2" id="alertsDropdown" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="fa fa-fw fa-bell"></i>
            <span class="d-lg-none">Vencimiento esterilización
              <span class="badge badge-pill badge-warning badgeAlertaFV">6 New</span> <!--  responsive -->
            </span>
            <span class="indicator text-warning d-none d-lg-block">
              <i class="fa fa-fw fa-circle alertaFV"></i>
        ...
        <li class="nav-item"> <!-- LogOut -->
          <a class="nav-link" data-toggle="modal" data-target="#equiposExtModal">
            <i class="fa fa-fw fa-sign-out"></i>Salir</a>
        </li>
      </ul> <!--nav top  -->
    </div>
  </nav>
  <div class="content-wrapper"> <!-- Contenido central -->
    <div class="container-fluid">
      <!-- Breadcrumbs-->
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#">Alertas ventas de insumos</a>
        </li>
      </ol>
      <!-- Icon Cards-->
      <!-- <div class="row">
        <div class="col-xl-4 col-sm-4 mb-12"> <!~~ Alertas ~~>
          <div class="card text-white bg-warning o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-list"></i>
              </div>
              <div class="mr-5">15 Alertas nuevas!</div>
            </div>
        ...
        <div class="col-xl-4 col-sm-4 mb-12"> <!~~ mensajes ~~>
          <div class="card text-white bg-primary o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-comments"></i>
              </div>
              <div class="mr-5">36 Mensajes!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Ver Detalles</span>
              <span class="float-right">
        ...
        <div class="col-xl-4 col-sm-4 mb-12"><!~~  Ordenes~~>
          <div class="card text-white bg-success o-hidden h-100">
            <div class="card-body">
              <div class="card-body-icon">
                <i class="fa fa-fw fa-shopping-cart"></i>
              </div>
              <div class="mr-5">13 Ordenes nuevas!</div>
            </div>
            <a class="card-footer text-white clearfix small z-1" href="#">
              <span class="float-left">Ver detalles</span>
              <span class="float-right">
      ...
      <div class="card mb-3 contTablaAlertas"> <!-- contenedor de la tabla de alertas -->
        <?php
          require_once("controlador_funciones.php");
          $mesActual=date("m");

          $mes1=getMes($mesActual-1);
          $mes2=getMes($mesActual-2);
        ?>
        <table class="table table-borderless" id="tablaAlertasInsumos">
          <thead>
            <tr>
              <th>Cliente</th>
              <th>Insumo</th>
              <th>Ventas <?php echo($mes1);  ?></th>
              <th>Ventas <?php echo($mes2);  ?></th>
            </tr>
          </thead>
          <tbody>
            <!-- <td>Insumo</td>
    ...
    <a class="scroll-to-top rounded" href="#page-top"> <!-- flechita para volver arriba -->
      <i class="fa fa-angle-up"></i>
    </a>
    <!-- ________ MODALS: ________ -->
    <!-- Logout Modal-->
