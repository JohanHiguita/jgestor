...
<html>
  ...
  <body class="bg-dark">
    <?php
      ...
      $serial= test_input($_GET["inpSerial"]);
      ...
      if (isset($_POST["usuario_adm"]) && $_POST["psw_adm"]){
        ...
        if ($existe) {
          ...
          if ($coinciden) {
            updateEquipoExt($infoEquipo);
            $linkExito="view_PermitidoEditarEquipoExt.php?nombre=" .$nombre. "&".
            "serial=" .$serial;
        ...
        if ($accesoNegado==1) {
          $linkNoAcceso="view_NegadoEditarEquipoExt.php?nombre=" .$nombre. "&".
          "serial=" .$serial;
