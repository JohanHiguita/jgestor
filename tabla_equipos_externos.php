...
<head>
  ...
  <title>jGestor - Equipos externos</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Equipos externos</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de Equipos externos</div>
          <?php //mostrar tabla de Clientes
            ...
            $header=getHeadersEquipos_ext();
            $matrizEquipos_ext=getTabla("equipos_ext");
            insertTable($header,$matrizEquipos_ext,"equiposExternos");
          ?>
    ...
    <!-- detalles Modal-->
    <div class="modal fade" id="detallesModal" tabindex="-1" role="dialog" aria-labelledby="equiposExtModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="equiposExtModalLabel">Detalles del Equipo</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <h5 id='nombre_ee'></h5><br/>
            <h5><b>Serial: </b></h5>
            <span  id='serial_ee'></span><br/>
            <h5><b>Placa: </b></h5>
            <span  id='placa_ee'></span><br/>
            <h5><b>Marca: </b></h5>
            <span  id='marca_ee'></span><br/>
            <h5 ><b>Modelo: </b></h5>
            <span id='modelo_ee'></span><br/>
            <h5 ><b>Estado: </b></h5>
            <span id='estado_ee'></span><br/>
            <h5 ><b>Modalidad: </b></h5>
            <span id='modalidad_ee'></span><br/>
            <h5 ><b>Cliente: </b></h5>
            <span id='cliente_ee'></span><br/>
            <h5 ><b>Ubicación: </b></h5>
            <span id='ubicacion_ee'></span><br/>
            <h5 ><b>Fin de garantía: </b></h5>
            <span id='garantia_ee'></span><br/>

            <h5 ><b>Fecha de compra: </b></h5>
            <span id='fechai_ee'></span><br/>
            <h5 ><b>Fecha de salida: </b></h5>
            <span id='fechao_ee'></span><br/>
            <h5 ><b>Precio de compra: </b></h5>
            <span id='precioc_ee'></span><br/>
            <h5 ><b>Precio de venta: </b></h5>
            <span id='preciov_ee'></span><br/>
            <div class="detallesEquipoExt">
              <!-- <button href="index.php" type="button" class="btn btn-xs">Ver procedimientos</button> -->
              <button id="btn_proc" class="btn btn-info btn-xs" role="button">Ver procedimientos</button>
    ...
    <div class="modal fade" id="editarModal" tabindex="-1" role="dialog" aria-labelledby="EditarModalLabel" aria-hidden="true">
      <div  class="modal-dialog" role="document">
        <div class="modal-content" id="modalContentEditar">
          <div class="modal-header">
            <h5 class="modal-title" id="EditarModalLabel">Editar equipo externo</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <div class="contEditarForm">
              <form id="formEditEquipoExt" class="editarEquipoExtForm" action="controlador_editarEquipoExt.php" method="get">
                <div class="row">
                  <div class="col-sm-6">
                    <label for="inpSerial">Serial:</label>
                  </div>
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpPlaca" id="inpPlaca"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpEstado" id="inpEstado"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <input type="text" name="inpUbicacion" id="inpUbicacion"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                  ...
                  <div class="col-sm-6">
                    <select type="text" name="inpModalidad" id="inpModalidad"></select><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="date" name="inpFechaGarantia" id="inpFechaGarantia"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="date" name="inpFechaSalida" id="inpFechaSalida"></input><br>
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-6">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="inpPrecioVenta" id="inpPrecioVenta"></input><br>
                  </div>
                </div>
          ...
          <div class="modal-footer">
            ...
            <button class="btn btn-success" type="submit" name="enviar" form="formEditEquipoExt">Actualizar</button>
            <!-- <a class="btn btn-primary" href="login.html">Logout</a> -->
          </div>
        </div>
      </div>
    ...
    <div class="modal fade" id="eliminarModal" tabindex="-1" role="dialog" aria-labelledby="eliminarModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="eliminarModalLabel">Eliminar registro de equipo</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body text-center">
            ¿Está seguro de eliminar el registro del equipo
