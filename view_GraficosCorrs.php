...
<head>
  ...
  <title>jGestor - Historial correctivos</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Mantenimientos correctivos</li>
      </ol>
      <?php
      ...
      <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
          <a class="nav-link active" data-toggle="tab" href="#mensual">Último mes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-toggle="tab" href="#anual">Último año</a>
        </li>
      </ul>
      <div class="tab-content">
        <div id="mensual" class="container tab-pane active"><br>
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-table"></i> Tabla de historial de correctivos del <b>último mes</b></div>
              <?php //mostrar tabla de Clientes
                $header=getHeadersCorrectivosYear(); //Mismo headers para mes y año
                $matrizCorrsM=getTablaCorrsMes();
                insertTable2($header,$matrizCorrsM,"corrsM");
              ?>
          </div>
        </div>
        <div id="anual" class="container tab-pane active"><br>
          <div class="card mb-3">
            <div class="card-header">
              <i class="fa fa-table"></i> Tabla de historial de correctivos del <b>último año</b></div>
              <?php //mostrar tabla de Clientes
              $header=getHeadersCorrectivosYear();
              $matrizCorrsY=getTablaCorrsYear();
              insertTable2($header,$matrizCorrsY,"corrsY");
              ?>
          </div>
        </div>
      </div>
    ...
    <!--Graficos correctivos Modal  -->
    <div class="modal fade" id="graficosCorrsModal" tabindex="-1" role="dialog" aria-labelledby="graficosCorrsModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="graficosCorrsModalLabel">Historial de correctivos</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body" id="contGraficoCorrs">
            <canvas id="Corrs_Equipo" width="100" height="50"></canvas>
