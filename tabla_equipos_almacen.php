  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Equipos en almacén</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de Equipos en almacén</div>
          <?php //mostrar tabla de Clientes
            ...
            $header=getHeadersEquipos_almacen();
            $matrizEquipos_almacen=getTabla("equipos_almacen");
            insertTable($header,$matrizEquipos_almacen,"equiposAlm");
          ?>
