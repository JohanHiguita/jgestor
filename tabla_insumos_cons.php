...
<head>
  ...
  <title>jGestor - insumos consignación</title>
  <!-- Bootstrap core CSS-->
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Insumos en consignación</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de insumos en consignación</div>
          <?php //mostrar tabla de Clientes
            ...
            $header=getHeadersInsumosCons();
            $matrizInsumos=getTabla("insumos_consignacion");
