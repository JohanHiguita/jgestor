  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Insumos vendidos</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Tabla de insumos vendidos</div>
          ...
          $header=getHeadersInsumosVend();
          $matrizInsumos=getTabla("insumos_vendidos");
          insertTableInsumosVendidos($header,$matrizInsumos);
          ?>
